...
class Simulation(db.Model):
    ...
    machine = db.relationship("Machine", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    mhd = db.relationship("MHD", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    cad = db.relationship("CAD", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    opticalHF = db.relationship("OpticalHF", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    photonHF = db.relationship("PhotonHF", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    gyroHF = db.relationship("GyroHF", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
    openFOAM = db.relationship("OpenFOAM", backref=db.backref("simulation", lazy=True, cascade="all, delete-orphans"))
